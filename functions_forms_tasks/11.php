...
function bigFirstLetter($text)
{
	$wordsArr = explode('. ', $text);
	$firstUpLetterArr = array();

	foreach($wordsArr as $word)
		$firstUpLetterArr[] = mb_strtoupper(mb_substr($word, 0, 1, 'UTF-8'), 'UTF-8') . mb_substr($word, 1, mb_strlen($word), 'UTF-8');

	$upLetterText = implode('. ', $firstUpLetterArr);
